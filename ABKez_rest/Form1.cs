...
namespace ABKez_rest
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_updateone_Click(object sender, EventArgs e)
        {
            this.updateOne();
        }
        ...
        private void getRest(string ALink)
        {
            ...
            if (responseStream.Length > 0)
            {
                ...
                {
                    memo.AppendText($"Error: {ex.Message}\n");
                }
            }
        }
        ...
        private void lv_datas_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void cbLinks_TextChanged(object sender, EventArgs e)
        {
            //memo.AppendText(cbLinks.Text + "\n");
        }
        ...
        {
            //memo.AppendText("APIKey changed!");
        }
    }
}
